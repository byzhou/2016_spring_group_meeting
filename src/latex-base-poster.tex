...
\newcommand{\posterbox}[1]{
    \begin{tcolorbox}[width=\textwidth,colback=yellow!10,colframe=red!70!black,title=#1,fonttitle=\LARGE,fontupper=\large]
}
    ...
    \begin{columns}
        \column{0.33\textwidth}
            \posterbox{Introduction}
                \begin{itemize}
                    ...
                    hard to be detected during the post-silicon verification.
        ...
        \column{0.33\textwidth}
            ...
            \posterbox{Detection Process}
                ...
                \begin{figure}[t]
                    \centering
                        \includegraphics[clip,width=0.33\textwidth]{img/mod/In.pdf}~
                        \includegraphics[clip,width=0.33\textwidth]{img/shi/In.pdf}~
                        \includegraphics[clip,width=0.33\textwidth]{img/rep/In.pdf}
                    \caption{
