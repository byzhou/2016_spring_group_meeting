...
\newcommand{\titlebox}{
    \begin{center}
        \begin{tcolorbox}[left=2cm,right=2cm,arc=2cm,boxrule=5mm,width=\textwidth,colframe=blue!70!black,colback=yellow!10]
            \begin{center}
}
...
\newcommand{\posterbox}[1]{
    \begin{tcolorbox}[arc=5mm,width=\textwidth,colback=yellow!10,colframe=blue!70!black,adjusted
        ...
        \begin{column}[T]{0.33\textwidth}
            ...
            \posterbox{Related work}
                \begin{itemize}
                    ...
                    include both destructive and non-destructive approaches.
                    ...
                    form of functional testing or side-channel analysis.
